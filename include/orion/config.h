...
/* include/orion/config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Define to enable perf measurements. */
/* #undef ENABLE_PERF */
...
#define PACKAGE_NAME "orion"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "orion 0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "orion"
...
#define orion_invariant(x, ...) do { if (!(x)) fail_masstree_invariant(__FILE__, __LINE__, #x, ## __VA_ARGS__); } while (0)
#else
#define orion_invariant(x, ...) do { } while (0)
#endif
...
#define orion_precondition(x, ...) do { if (!(x)) fail_masstree_precondition(__FILE__, __LINE__, #x, ## __VA_ARGS__); } while (0)
#else
#define orion_precondition(x, ...) do { } while (0)
#endif

#ifndef invariant
#define invariant orion_invariant
#endif
#ifndef precondition
#define precondition orion_precondition
#endif
